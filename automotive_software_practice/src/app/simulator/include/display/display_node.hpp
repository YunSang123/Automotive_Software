...
class Display : public rclcpp::Node {
    ...
    private:
        ...
        void DisplayCsvLanes(const ad_msgs::msg::LanePointDataArray& csv_lanes,
                             const rclcpp::Time& current_time);
        void DisplayObstacles(const ad_msgs::msg::Obstacles& obstacles,
        ...
        rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr p_obstacles_marker_;
        ...
        rclcpp::Subscription<ad_msgs::msg::Obstacles>::SharedPtr s_obstacles_; // Changed message type
        ...
        double time_obstacle_marker_ = 0.0;

        // Simulator       
        bool param_is_vehicle_ = false; 
        bool param_is_obstacle_ = false;
};
